<template>
  <a-layout>
    ...
    <a-layout :style="{ paddingLeft: paddingLeft }">
      <global-header :menuData="menuData" :collapsed="collapsed" @toggleCollapse="toggleCollapse" style="background-image: url('../../../static/img/river-6968614.png')"/>
      <a-layout-content :style="{minHeight: minHeight, width: '1200px', marginTop: '78px'}" :class="fixHeader ? 'fixed-header-content' : null">
        <slot></slot>
      </a-layout-content>
