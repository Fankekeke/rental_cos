  ...
  <a-layout-header class="ant-layout-header ant-header-fixedHeader light global-header">
    <div :class="['global-header-wide', layout]" style="width: 1200px;margin: 0 auto">
      <router-link v-if="isMobile || layout === 'head'" to="/" :class="['logo', isMobile ? null : 'pc', theme]" style="vertical-align: middle;">
        <img width="58" src="static/img/llll.jpg"  alt=""/>
      ...
      <div v-if="layout === 'head'" class="global-header-menu" style="float: right">
        <a-menu v-model="current" mode="horizontal" style="height: 85px; line-height: 85px;" class="system-top-menu">
          ...
          <a-menu-item key="product" style="color: #303133;letter-spacing: 2px;font-family: SimHei" @click="$router.push('/rent')">租房</a-menu-item>
