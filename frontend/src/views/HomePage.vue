<template>
  <div :class="[multipage === true ? 'multi-page':'single-page', 'not-menu-page', 'home-page']">
    <a-row :gutter="8" class="head-info" style="margin: 0">
        ...
        <a-col :span="12">
          <div>
            <a-row class="more-info" v-if="user.roleId != 75">
              ...
              <a-col :span="4"></a-col>
              <a-col :span="4">
                <head-info title="房源数量" :content="todayIp" :center="false" :bordered="false"/>
              </a-col>
              <a-col :span="4">
                <head-info title="小区数量" :content="todayVisitCount" :center="false" :bordered="false"/>
              </a-col>
              <a-col :span="4">
                <head-info title="销售人员" :content="totalVisitCount" :center="false" />
              </a-col>
            </a-row>
          </div>
        </a-col>
